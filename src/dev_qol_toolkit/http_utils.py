...
class AsyncAPIClient:
    ...
    async def get(self, path: str, **kwargs: Any) -> Any:
        ...
        return await async_api_request("GET", self._url(path), headers=self.headers, timeout=self.timeout, **kwargs)

    async def post(self, path: str, **kwargs: Any) -> Any:
        """Make async POST request."""
        return await async_api_request("POST", self._url(path), headers=self.headers, timeout=self.timeout, **kwargs)

    async def put(self, path: str, **kwargs: Any) -> Any:
        """Make async PUT request."""
        return await async_api_request("PUT", self._url(path), headers=self.headers, timeout=self.timeout, **kwargs)

    async def delete(self, path: str, **kwargs: Any) -> Any:
        """Make async DELETE request."""
        return await async_api_request("DELETE", self._url(path), headers=self.headers, timeout=self.timeout, **kwargs)

    async def patch(self, path: str, **kwargs: Any) -> Any:
        """Make async PATCH request."""
        return await async_api_request("PATCH", self._url(path), headers=self.headers, timeout=self.timeout, **kwargs)
