"""Performance benchmark tests for dev_qol_toolkit."""
...
from dev_qol_toolkit import (
    json_utils, file_utils, string_utils, security_utils,
    data_utils, validation_utils
)
    ...
    def test_string_validation_performance(self):
        ...
        def validate_all():
            ...
            for email, url in test_data:
                results.extend([
                    string_utils.validate_email(email),
                    string_utils.validate_url(url)
                ])
            return results
...
class TestSecurityPerformance:
    ...
    def test_password_hashing_performance(self):
        ...
        benchmark = PerformanceBenchmark("Password hashing", target_time=5.0)  # Hashing is intentionally slow
...
class TestMemoryUsage:
    ...
    def test_json_memory_usage(self, tmp_path: Path):
        ...
        assert peak < 50 * 1024 * 1024, f"JSON save used too much memory: {peak / 1024 / 1024:.1f}MB"
        ...
        assert peak < 50 * 1024 * 1024, f"JSON load used too much memory: {peak / 1024 / 1024:.1f}MB"
    ...
    def test_string_processing_memory_usage(self):
        ...
        assert peak < 100 * 1024 * 1024, f"String processing used too much memory: {peak / 1024 / 1024:.1f}MB"
