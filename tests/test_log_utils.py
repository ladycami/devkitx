...
from dev_qol_toolkit.log_utils import setup_logging, log_time, log_calls
...
class TestSetupLogging:
    ...
    def test_basic_setup(self):
        ...
        assert logger.name == "dev_qol_toolkit"
    ...
    def test_loguru_fallback(self):
        ...
        with patch.dict('sys.modules', {'loguru': None}):
            with patch('dev_qol_toolkit.log_utils.logging.getLogger') as mock_get_logger:
                mock_logger = Mock()
...
class TestLogTime:
    ...
    def test_log_time_default_logger(self):
        ...
        with patch('logging.getLogger') as mock_get_logger:
            ...
            mock_get_logger.assert_called_with("dev_qol_toolkit")
...
class TestLogCalls:
    ...
    @given(
        ...
        kwargs=st.dictionaries(st.text(min_size=1, max_size=10), st.integers(), min_size=0, max_size=3)
    )
